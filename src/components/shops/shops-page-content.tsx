...
const ShopsPageContent: React.FC = () => {
  ...
  return (
    <div className="border-t bg-white border-gray-300 pt-10 lg:pt-12 xl:pt-14 pb-14 lg:pb-16 xl:pb-20 px-4 md:px-8">
          ...
          <div className="flex-shrink-0 flex items-center space-x-1.5 ms-2">
            <button
              ...
              className={`text-2xl relative top-[1px] transition-all ${
                gridView === false ? "text-yellowSps" : "text-heading"
              }`}
            ...
            <button
              ...
              className={`text-lg transition-all ${
                gridView === true ? "text-yellowSps" : "text-heading"
              }`}
