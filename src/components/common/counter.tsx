  ...
  return (
    <div
      className={cn(
        ...
        {
          "border h-11 md:h-12 border-yellowSps": variant === "default",
          "h-8 md:h-9 shadow-navigation bg-white": variant === "dark",
        }
      )}
    >
      <button
        ...
        className={cn(
          ...
          {
            "w-10 md:w-12 text-heading border-e border-gray-300  hover:bg-yellowSps hover:text-heading":
              variant === "default",
      ...
      <button
        ...
        className={cn(
          ...
          {
            "w-10 md:w-12 text-heading border-s border-gray-300 hover:bg-yellowSps hover:text-heading":
              variant === "default",
            "w-8 md:w-9 text-white bg-heading hover:bg-gray-600 focus:outline-none":
              variant === "dark",
          }
