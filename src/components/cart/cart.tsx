...
export default function Cart() {
	...
	return (
		<div className=" flex flex-col w-full h-full justify-between">
			<div className="w-full flex justify-between items-center bg-graySps relative ps-5 md:ps-7 py-0.5 border-b border-gray-100">
				...
				<button
					...
					aria-label="close"
				>
					<IoClose className="text-heading mt-1 md:mt-0.5" />
				</button>
			</div>
			{!isEmpty ? (
