...
const ProductCard: FC<ProductProps> = ({
  ...
  return (
    ...
    <div
      className={cn(
        "group box-border overflow-hidden flex rounded-md cursor-pointer border-r-2 border-purpleSps border-b-2 shadow-items ",
        {
          ...
          "items-center bg-white border border-gray-100 transition duration-200 ease-in-out transform hover:-translate-y-1 hover:shadow-listProduct":
            variant === "listSmall",
    ...
    >
      ...
      >
        ...
        {description && (
          <p className="text-gray-400 text-xs md:text-[13px] lg:text-sm leading-normal xl:leading-relaxed max-w-[250px] truncate">
            {description}
          </p>
        )}
        <div
