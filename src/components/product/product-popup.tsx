...
export default function ProductPopup({ productSlug }: { productSlug: string }) {
  ...
  return (
    <div className="rounded-lg bg-graySps">
        ...
        <div className="flex flex-col p-5 md:p-8 w-full">
          <div className="pb-5">
            <div
              ...
              role="button"
            >
              <h2 className="text-heading text-lg md:text-xl lg:text-2xl font-semibold hover:text-yellowSps">
                {product.name}
              </h2>
            </div>

            {product.unit && isEmpty(variations) && (
              <span className="text-sm font-normal text-gray-350 mt-2 md:mt-3 block">
                {product.unit}
              </span>
            )}

            <p className="text-sm leading-6 md:text-heading md:leading-7">
              {product.description}
            </p>
