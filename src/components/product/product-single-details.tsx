    ...
    <div className="block lg:grid grid-cols-9 gap-x-10 xl:gap-x-14 pt-7 pb-10 lg:pb-14 2xl:pb-20 items-start">
      ...
      <div className="col-span-4 pt-8 lg:pt-0">
        <div className="pb-7 border-b border-gray-300">
          <h2 className="text-heading text-lg md:text-xl lg:text-2xl 2xl:text-3xl font-bold hover:text-yellowSps mb-3.5">
            {product?.name}
          </h2>
          <p className="text-gray-400 text-sm lg:text-base leading-6 lg:leading-8">
            {product?.description}
          </p>
                ...
                <li>
                  ...
                  {product.categories.map((category: any, index: number) => (
                    <Link
                      ...
                      className="transition hover:underline hover:text-yellowSps"
                    >
                ...
                <li className="productTags">
                  ...
                  {product.tags.map((tag: any) => (
                    <Link
                      ...
                      className="inline-block pe-1.5 transition hover:underline hover:text-yellowSps last:pe-0"
                    >
                      {tag.name}
