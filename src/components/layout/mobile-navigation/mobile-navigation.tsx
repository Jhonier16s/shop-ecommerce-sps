...
const BottomNavigation: React.FC = () => {
  ...
  const [ isAuthorize ] = useAtom(authorizationAtom);
	...
	return (
		<>
			<div className="md:hidden fixed z-10 bottom-0 flex items-center justify-between shadow-bottomNavigation text-white body-font bg-blackSps w-full h-14 sm:h-16 px-4">
				<button
					aria-label="Menu"
