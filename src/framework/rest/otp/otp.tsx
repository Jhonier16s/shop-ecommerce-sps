      ...
      {!hasOTP ? (
        <div className="flex items-center">
          <PhoneInput
            ...
            inputClass="!p-0 !pe-4 !ps-14 !flex !items-center !w-full !appearance-none !transition !duration-300 !ease-in-out !text-heading !text-sm focus:!outline-none focus:!ring-0 !border !border-gray-300 !border-e-0 !rounded !rounded-e-none focus:!border-black !h-12"
          ...
          <Button
            ...
            className="!rounded-s-none flex-shrink-0 capitalize !h-12 !px-6"
          >
            {t("text-send-otp")}
          </Button>
        </div>
